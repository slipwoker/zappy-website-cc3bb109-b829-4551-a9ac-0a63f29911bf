document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if ((type === 'tel' || name.toLowerCase().includes('phone')) && !isValidPhone(value)) {
        ...
        if (field.maxLength && field.maxLength > 0 && value.length > field.maxLength) {
          showError(field, 'Must be no more than ' + field.maxLength + ' characters.');
          return false;
        }
      }
  ...
  const animatedElements = document.querySelectorAll(
    '.animate-on-scroll, [data-animate], .feature-card, .service-card, .pricing-card, .testimonial-card, .team-card, .section-title, .hero-content'
  );
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'cc3bb109-b829-4551-a9ac-0a63f29911bf',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'cc3bb109-b829-4551-a9ac-0a63f29911bf';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'cc3bb109-b829-4551-a9ac-0a63f29911bf';
